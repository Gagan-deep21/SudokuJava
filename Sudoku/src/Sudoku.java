//This java program uses backtracking algorithm
//This code generates random numbers to check the values in the rows and columns and choose the best
//solution checking the value present in the generated numbers.
//The Panel.java file helps generate the basic layout of the application made and the Sudoku.java files
//runs the alrogithm for the application designed 
...
public class Sudoku {
    ...
    public static void newGame() {
        ...
        if (search(grid)) {
            System.out.println("Thank You for using the Game");
        }
