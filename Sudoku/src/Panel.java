...
public class Panel extends javax.swing.JPanel {
    ...
    public Panel() {
        ...
        cBtn = new JButton("Check(Time +30s)");
        ...
        slove = new JButton("<-- solve(Require Password)");

        slove.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (pass.getText().equals("doityourself")) {
                    timer.stop();
                    counter = 0;
                    label.setText(TimeFormat(counter));
                    for (int i = 0; i < 9; i++) {
    ...
    private String TimeFormat(int count) {
        ...
        return String.format("      Timer :" + "%02d", hours) + " : " + String.format("%02d", minutes) + " : "
